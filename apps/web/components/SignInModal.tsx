    ...
    >
      ...
      >
        ...
        <div className="p-8">
          ...
          <button className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-white/[0.1] bg-white hover:bg-white/90 active:scale-[0.99] text-[#1a1a1a] font-semibold text-sm transition-all duration-150 shadow-[0_2px_8px_rgba(0,0,0,0.4)]">
