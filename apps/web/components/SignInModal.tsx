...
import { dummySignIn } from "@/lib/dummy-auth";
      ...
      >
        ...
        <div className="p-8">
          ...
          <form action={dummySignIn}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-white/[0.1] bg-white hover:bg-white/90 active:scale-[0.99] text-[#1a1a1a] font-semibold text-sm transition-all duration-150 shadow-[0_2px_8px_rgba(0,0,0,0.4)]"
            >
          ...
          <p className="mt-6 text-center text-[11px] text-muted-foreground/35 leading-relaxed">
            ...
            <a href="#" className="underline underline-offset-2 hover:text-muted-foreground/60 transition-colors">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" className="underline underline-offset-2 hover:text-muted-foreground/60 transition-colors">
